class AccountsController < ApplicationController
  ...
  #  end
    ...
    def find_account
      ...
      def account_params
        params.require(:account).permit(:confirmed, :account_balance, :account_number, :phone_number, :dob, :routine_number, :user_id, :slug, :account_type, :account_pin, :image, :mother_name)
      end
end
